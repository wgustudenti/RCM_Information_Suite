 ...
 */
public abstract class SQLGeneralSuggestion {
     ...
     */
    private static final String tableName = "GeneralSuggestion";
    ...
    public static void insert(String description, int categoryID) throws SQLException {
        ...
        String query = "INSERT INTO " + tableName + " (Description, CategoryID) VALUES ('" + description + "', "
                + categoryID + ");";
        SQLGeneral.executeUpdate(query);
    }
    ...
    public static void update(String description, int categoryID, int primaryKey) throws SQLException {
        description = SQLGeneral.escapeApostrophes(description);
        String query = "UPDATE " + tableName + " SET Description='" + description + "', CategoryID=" + categoryID
