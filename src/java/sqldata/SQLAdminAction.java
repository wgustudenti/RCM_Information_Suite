 ...
 */
public abstract class SQLAdminAction {
     ...
     */
    private static final String tableName = "AdminAction";
    ...
    public static void insertTestData() throws SQLException {
        ...
        insert("Add Provider");
        insert("Update Provider");
        insert("Delete Provider");
        insert("Add Payer");
        insert("Update Payer");
        insert("Delete Payer");
        insert("Add Remark Code");
        insert("Update Remark Code");
        insert("Delete Remark Code");
        insert("Add Tip Of The Day");
        insert("Update Tip Of The Day");
        insert("Delete Tip Of The Day");
        insert("Add Suggestion Category");
        insert("Update Suggestion Category");
        insert("Delete Suggestion Category");
        insert("Insert Payer For All Clients");
        insert("Update Payer For All Clients");
    }
}
