 ...
 */
public abstract class SQLTipOfTheDaySuggestion {
     ...
     */
    private static final String tableName = "TipOfTheDaySuggestion";
    ...
    public static void insertTestData() throws SQLException {
        insert("Brush your teeth");
        insert("Brush your coworker's teeth");
        insert("Be on time");
    }
}
