 ...
 */
public abstract class SQLSuggestionCategory {
     ...
     */
    private static final String tableName = "SuggestionCategory";
    ...
    public static void createTable() throws SQLException {
        String query = "CREATE TABLE SuggestionCategory(\n" +
    ...
    public static void update(String description, int primaryKey) throws SQLException {
        description = SQLGeneral.escapeApostrophes(description);
        String query = "UPDATE " + tableName + " SET Description='" + description + "' WHERE " + primaryKeyColName
                + " = " + primaryKey + ";";
        SQLGeneral.executeUpdate(query);
    }
    ...
    public static void insertTestData() throws SQLException {
        insert("Software");
        insert("Hardware/Supplies");
        insert("Policies/Practices");
        insert("Other");
    }
}
