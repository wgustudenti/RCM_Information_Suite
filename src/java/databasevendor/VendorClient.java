...
import sqlitedata.SQLiteClient;
 ...
 * the vendor.
 */
public abstract class VendorClient {
    ...
    public static void update(String name, String departmentNotes, String specialtyNotes, int primaryKey) throws SQLException {
        if(SQLConnection.getVendor().toLowerCase().contains("sqlite")){
            SQLiteClient.update(name, departmentNotes, specialtyNotes, primaryKey);
        }
    }
    ...
    public static void delete(int primaryKey) throws SQLException {
        if(SQLConnection.getVendor().toLowerCase().contains("sqlite")){
            SQLiteClient.delete(primaryKey);
        }
    }
