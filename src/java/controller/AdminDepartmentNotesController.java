 ...
 */
public class AdminDepartmentNotesController extends InformationSuiteController implements Initializable {
    ...
    void editButtonClick(ActionEvent event) throws IOException {
        EditDepartmentNotesController.setPreviousScene("/view/AdminDepartmentNotes.fxml");
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        notesTextArea.setText(selectedClient.getDepartmentNotes());
    }
}
